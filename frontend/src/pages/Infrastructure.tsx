                ...
                <section className="relative py-14 lg:py-20 overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 space-y-16">
                        ...
                        <div className="max-w-4xl mx-auto text-center space-y-8">
                            ...
                            <p className="text-slate-600 text-lg leading-relaxed font-display">
                                The school canteen provides fresh, hygienic, and nutritious food for students and staff in a clean and welcoming environment.
                            </p>

                            <p className="text-slate-500 text-base leading-relaxed font-display">
                                Healthy eating habits are encouraged by providing quality snacks and refreshments prepared under hygienic conditions.
                            </p>

                            <p className="text-slate-500 text-base leading-relaxed font-display">
                                The canteen also serves as a comfortable space where students can relax and interact during breaks.
                            </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-xl border-4 border-white group">
                                ...
                                <div className="absolute bottom-6 left-6 text-white">
                                    ...
                                    <p className="text-xs opacity-80 text-brand-gold">Comfortable Seating</p>
                                </div>
                            </div>
                            ...
                            <div className="relative aspect-[4/3] rounded-[2rem] overflow-hidden shadow-xl border-4 border-white group">
                                ...
                                <div className="absolute bottom-6 left-6 text-white">
                                    ...
                                    <p className="text-xs opacity-80 text-brand-gold">Healthy & Nutritious</p>
                                </div>
                            </div>
                        </div>
